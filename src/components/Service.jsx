    ...
    <section className="max-w-screen-xl px-8 w-full flex flex-col mt-14 mx-auto">
      ...
      <div className="w-full mx-auto mt-4">
        {services.map((serve) => (
          <div
            key={serve.title}
            className={`flex max-w-5xl mx-auto w-full min-h-[400px] items-center justify-between flex-col 
          ...
          >
            ...
            >
              <h1 className="text-2xl md:text-3xl text-center md:text-start text-textBackground font-[600] mb-4">
                {serve.title}
              </h1>
            ...
            <div
              className={`max-w-[400px] w-full min-h-64 mt-2
